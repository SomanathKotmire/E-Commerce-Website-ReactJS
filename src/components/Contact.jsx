				...
				<div className="container">
						...
						<div className="col-sm-12" >
							...
							<div className="row contact-info-wrap">
								<div className="col-md-3">
									<p style={{ color: "black" }}><span><i class="fa-solid fa-location-dot"></i></span> 4th Lane, E Ward, Shahupuri,  <br /> Kolhapur, Maharashtra 416001.</p>
								</div>
								<div className="col-md-3">
									<p><span><i class="fa-solid fa-phone"></i></span> <a href="tel://1234567920">+ 1235 2355 98</a></p>
								</div>
								<div className="col-md-3">
									<p><span><i class="fa-regular fa-paper-plane"></i></span> <a href="mailto:info@myfootwear.com">info@myfootwear.com</a></p>
								</div>
								<div className="col-md-3">
									<p><span><i class="fa-solid fa-globe"></i></span> <a href="#">myfootwear.com</a></p>
								</div>
							</div>
						</div>
					</div>
					<div className="row">
						<div className="col-md-6">
							<div className="contact-wrap" style={{ backgroundImage: `url(${c1})` }}>
